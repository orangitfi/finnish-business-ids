...
describe('finnish-business-ids', function () {
    describe('#isValidBusinessId', function () {
        ...
        it('Should fail when checksum % 11 equels to 1', function () {
            chai_1.expect(finnish_business_ids_1.FinnishBusinessIds.isValidBusinessId('1375045-1')).to.equal(false);
        });
    });
